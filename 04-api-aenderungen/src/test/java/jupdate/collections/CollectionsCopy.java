...
public class CollectionsCopy {
	...
	private static void unmodifiableCollectionsWiederholung() {
		System.out.println("Widerholung zu unmodifiable Collections:");
	...
	private static void collectionsCopy() {
		...
		strings.add("b");
		System.out.println("List.copyOf: " + stringsCopy);
	...
	private static void mapCopy() {
		...
		Map<String, Integer> valuesCopy = Map.copyOf(values);
		...
		values.put("b", 2);
		System.out.println("Map.copyOf: " + valuesCopy);
	}
}
